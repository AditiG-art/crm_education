...
if($userCheck) {
    ...
    if($row['cnt'] == 0) {
        ...
        mysqli_query($conn, "INSERT INTO users (full_name, email, password, role, status) VALUES 
            ('Administrator', 'admin@crm.com', '$adminPass', 'admin', 'Active'),
            ('Dr. Sarah Jenkins', 'teacher@crm.com', '$teacherPass', 'teacher', 'Active'),
            ('Alex Rivera', 'student@crm.com', '$studentPass', 'student', 'Active')");
    }
}
