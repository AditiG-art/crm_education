...
// Optimized Auto Table Schema Setup & Seeding (Runs ONLY if tables do not exist yet)
$schemaCheck = @mysqli_query($conn, "SELECT 1 FROM users LIMIT 1");
...
if(!$schemaCheck) {
    $tables = [
        ...
        "CREATE TABLE IF NOT EXISTS results (
            ...
            created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
            INDEX idx_student_subj (student_id, subject)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;",
