...
// Fast schema check: run DDL statements only if database is uninitialized
$schemaInitCheck = @mysqli_query($conn, "SHOW TABLES LIKE 'colleges'");
if(!$schemaInitCheck || mysqli_num_rows($schemaInitCheck) == 0) {
